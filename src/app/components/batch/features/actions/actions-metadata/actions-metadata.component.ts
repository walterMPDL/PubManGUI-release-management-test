...
} from './actions-metadata-external-references/actions-metadata-external-references.component';
...
} from './actions-metadata-publication/actions-metadata-publication.component';
